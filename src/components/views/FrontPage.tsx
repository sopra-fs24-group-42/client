...
const FrontPage = () => {
  ...
  let popoverContent = (
    <div>
      ...
      <div className="frontpage detailed-instructions">Survive the night is a party game which requires at least 4 people to play. A designated player creates a new game, allowing others to join via a unique game code.<br></br>Once everyone has joined, every player will receive a role, which must be kept a secret. Usually, there must be at least 1 <b>protector</b>, 1 <b>seer</b>, 1 <b>sacrifice</b> and 1 <b>werewolf</b> in a game (depending on the number of players), with the remaining players being <b>villagers</b>, but these settings can be changed by the host while waiting for all players to join.<br></br>Villagers, seers, protectors and sacrifices are on the same team. Villagers win when they have identified and voted out all werewolf players. The werewolves win when the number of players left on the villagers team is less than or equal to the number of werewolves left in the game.
      </div>
    </div>
  );
