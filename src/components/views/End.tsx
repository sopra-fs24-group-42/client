...
const End = () => {
  ...
  return (
    <BaseContainer>
      <div className= "nightAction header">THE GAME HAS ENDED
        <BaseContainer>
          {(() => {
            if(ready && selected) {
              return (
                <div className= "nightAction heading2">THE GAME HAS ENDED</div>)}
              ...
              return (
                <div>
                  <div className= "nightAction heading">THIS PAGE IS UNDER CONSTRUCTION.</div>    
