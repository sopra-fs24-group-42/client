...
const TextSamplesRevealNightpost = [
  "As dawn breaks over the quaint village, the first rays of sunlight pierce through the veil of darkness, casting a warm glow upon the cobblestone streets and thatched-roof cottages. The village stirs from its slumber, awakening to the gentle whispers of the morning breeze.
  ...
  "3",
  "4",
  "Upon discovery, the of the nights outcome, all residents of our small village gather to discuss who they suspect to be",
  ];    
    export default TextSamplesRevealNightpost;